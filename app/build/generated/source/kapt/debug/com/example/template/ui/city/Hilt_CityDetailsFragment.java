...
public abstract class Hilt_CityDetailsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CityDetailsFragment_GeneratedInjector) this.generatedComponent()).injectCityDetailsFragment(UnsafeCasts.<CityDetailsFragment>unsafeCast(this));
    }
  }
